...
| `dropdownAnimation` | `{}` | "slideUp"    | Animation variant for the Dropdown container. You can pass an animation object here to get a custom animation.                                                             |
| `itemAnimation`     | `{}` | "slideUp"    | Animation variant for the Dropdown Items.You can pass an animation object here to get a custom animation.                                                                 |
