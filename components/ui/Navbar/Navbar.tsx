  ...
  return (
    <header className="fixed left-0 right-0 top-0 z-[9999] flex h-max w-screen items-center md:justify-center justify-end py-4 px-4 md:w-full md:px-32 md:py-4 backdrop-blur-xl bg-[rgb(77,77,77)]/[0.1%] after:content-[''] after:absolute after:w-full md:after:h-[0.5px] after:h-[1px] after:bg-gradient-to-r from-[#787878]/0 via-[#DEDEDE] to-[#787878]/0 after:bottom-0 after:right-0 after:opacity-50">
      ...
      <motion.div
        ...
        className="absolute top-0 right-0 z-[100] flex h-screen w-full flex-col items-start justify-start gap-5 backdrop-blur-2xl bg-black/80 text-white shadow-lg"
      >
